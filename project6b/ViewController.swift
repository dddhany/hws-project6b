...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let vflVertical = "V:|[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]->=10-|"
        view.addConstraints(NSLayoutConstraint.constraintsWithVisualFormat(vflVertical, options: [], metrics: metrics, views: viewsDictionary))
    }
